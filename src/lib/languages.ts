...
/**
 * A comprehensive list of languages with their ISO 639-1 codes.
 * This includes the most commonly translated languages.
 */
...
/**
 * Find languages matching a search query (searches both code and name)
 */
